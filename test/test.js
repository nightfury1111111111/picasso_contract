...
// const MARKETPLACE_PLATFORM_FEE = '0'  // 5%
// const MINT_FEE = '0';
...
contract(
  ...
  function ([
    ...
    beforeEach(async function () {
      ...
      this.picasso = await Picasso.new(platformFeeRecipient, platformFee);
      ...
      await this.fantomAddressRegistry.updatePicasso(this.picasso.address);
    ...
    describe("Minting and auctioning NFT", function () {
        ...
        console.log(`
            *The difference of the artist's FTM balance should be more than ${PLATFORM_FEE} FTM as 
            ...
            but should be less than ${
              PLATFORM_FEE + 1
            } FTM as the gas fees shouldn't be more than 1 FTM`);
        expect(
      ...
      it("Scenario 3", async function () {
        ...
        result = await this.picasso.mint(
          artist,
        ...
        console.log(`
            *The difference of the artist's FTM balance should be more than ${
              2 * PLATFORM_FEE
            } FTMs as 
            the platform fee is ${PLATFORM_FEE} FTM and minting costs some gases
            but should be less than ${
        ...
        console.log(`
            *The difference of the recipients's FTM balance should be ${
              PLATFORM_FEE * 2
            } FTMs as the platform fee is ${PLATFORM_FEE} FTMs `);
        expect(weiToEther(balance4) * 1 - weiToEther(balance2) * 1).to.be.equal(
          PLATFORM_FEE * 2
        );
