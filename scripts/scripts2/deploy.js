...
async function main(network) {
  ...
  ////////////
  const Picasso = await ethers.getContractFactory("Picasso");
  const picasso = await Picasso.deploy(TREASURY_ADDRESS, "0");

  await picasso.deployed();
  console.log("FantomPicasso deployed at", picasso.address);
  ///////////
  ...
  console.log(
    "FantomBundleMarketplace deployed to:",
  ...
  console.log(
    "FantomArtTradablePrivate deployed to:",
  ...
  console.log(
    "FantomArtFactoryPrivate deployed to:",
  ...
  await addressRegistry.updatePicasso(picasso.address);
