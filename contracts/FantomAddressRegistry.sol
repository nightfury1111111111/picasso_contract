...
contract FantomAddressRegistry is Ownable {
    ...
    /// @notice Picasso contract
    address public picasso;
    ...
    /**
     @notice Update picasso contract
     @dev Only admin
     */
    function updatePicasso(address _picasso) external onlyOwner {
        require(
            IERC165(_picasso).supportsInterface(INTERFACE_ID_ERC721),
            "Not ERC721"
        );
        picasso = _picasso;
    }
